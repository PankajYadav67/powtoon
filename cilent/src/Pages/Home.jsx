    ...
    return (
        <>
            <div >
                ...
                {/* box-1 */}
                <div className='bg-[#4e18dd] flex justify-center items-center text-white h-[500px] '>
                    <div className='ml-14 space-y-2 '>
                        <h2 className=' font-bold ' style={{ fontSize: "40px" }}>Create Jaw-Dropping
                        ...
                        <button className='rounded-full px-12 py-3 bg-white text-blue-700 hover:text-white hover:bg-[#42a5f5]'>START NOW</button>
                    </div>
                    <div className='mx-14'>
                        <iframe
                            width="650"
